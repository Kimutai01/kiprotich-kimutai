    ...
    <div className="w-ful bg-[#181822] h-[100vh] text-white">
      ...
      <div className="max-w-[1240px] mx-auto p-12 grid md:grid-cols-5  gap-8 pt-5">
        <div className="col-span-4">
          ...
          >
            This is a web application that allows users to book vetinary
            services and also get information about the vetinary. Vetinary
            clinics can also register their clinics and add their services.
            Built in Django, and Tailwind CSS
          </p>
          <Link href="http://144.126.238.221:8002/">
