    ...
    <div className="w-full bg-[#181822] sen h-[100vh] text-white">
      ...
      <div className="max-w-[1240px] mx-auto p-12 grid md:grid-cols-5  gap-8 pt-5">
        <div className="col-span-4">
          ...
          >
            This is a ticketing system for JKUAT students to book tickets for
            events and also get information about the events.
          </p>
          <Link href="https://jkuatses.co.ke/" target="_blank">
