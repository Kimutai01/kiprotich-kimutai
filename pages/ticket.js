    ...
    <div className="w-ful bg-[#181822] h-[100vh] text-white">
      ...
      <div className="max-w-[1240px] mx-auto p-12 grid md:grid-cols-5  gap-8 pt-5">
        <div className="col-span-4">
          ...
          >
            This is a ticketing system where users can buy tickets for
            thekultureke. Accepts both Mpesa and card payments.
          </p>
          <Link href="https://thekultureke.com/" target="_blank">
